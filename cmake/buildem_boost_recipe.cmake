...
macro(buildem_boost_recipe )
  ...
  if(BUILD_DebugAndRelease)
    set(Boost_VARIANTS "debug,release")
  else()
    set(Boost_VARIANTS "$<CONFIG>")
  endif()
  set(Boost_CONFIGS "")
  set(_binary_dir ${CMAKE_CURRENT_BINARY_DIR}/Boost-prefix/src/Boost-build)
	...
	set(Boost_OPTS threading=multi variant=${Boost_VARIANTS} runtime-link=shared link=${Boost_LINK} toolset=${Boost_TOOLSET} address-model=${Boost_ADDRESS_MODEL} install --prefix=${_prefix} --build-dir=${_binary_dir})
